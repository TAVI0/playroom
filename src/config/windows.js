// Configuración centralizada de las ventanas del escritorio estilo XP: ancho,
...
export const Z_INDEX = {
	...
	lightbox: 70, // imagen a pantalla completa, por encima de todo lo demas (incluido Clippy)
};
