...
function MobileSection({ title, icon, children }) {
	return (
		<section className="win-window p-[3px] w-full">
			...
			<div className="bg-win-face p-3">{children}</div>
		</section>
	);
}
...
export default function MobileHome() {
	...
	return (
		<div className="min-h-screen bg-win-desktop flex flex-col gap-4 p-3 font-win">
			{/* 1. Bienvenido */}
			...
			<a
				...
				className="win-btn flex items-center justify-center gap-2 py-3 text-base font-win"
			>
				📄 Descargar CV
			</a>
